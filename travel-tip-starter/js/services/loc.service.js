...
function setFilterBy(filterBy = {}) {
    if (filterBy.txt !== undefined || filterBy.loc.geo.address !== undefined) gFilterBy.txt = filterBy.txt
...
function getLocCountByUpdates() {
    return storageService.query(DB_KEY)
        .then(locs => {
            ...
            locCountByUpdates.total = locs.length
            return locCountByUpdates
        })
}
